module.exports = [
"[project]/node_modules/@copilotkitnext/shared/dist/utils.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@copilotkitnext/shared/dist/logger.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@copilotkitnext/shared/dist/constants.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@copilotkitnext/shared/dist/finalize-events.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    for (const [toolCallId, info] of openToolCalls){
        ...
        if (terminalEventMissing && !info.hasResult) {
            const resultEvent = {
                ...
                toolCallId,
                messageId: `${toolCallId ?? (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["randomUUID"])()}-result`,
                role: "tool",
...
"[project]/node_modules/@copilotkitnext/shared/dist/transcription-errors.mjs [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/@copilotkitnext/shared/dist/index.mjs [app-ssr] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([]);
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@copilotkitnext/shared/dist/utils.mjs [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$logger$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@copilotkitnext/shared/dist/logger.mjs [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$finalize$2d$events$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@copilotkitnext/shared/dist/finalize-events.mjs [app-ssr] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phoenix$2f$priv$2f$static$2f$phoenix$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/phoenix/priv/static/phoenix.mjs [app-ssr] (ecmascript)");
;
;
;
;
...
*/ function withAbortErrorHandling(observable) {
    return observable.pipe((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$operators$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["catchError"])((error)=>{
        if (isZodError(error)) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EMPTY"];
        throw error;
    }));
}
var ProxiedCopilotRuntimeAgent = class extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$client$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["HttpAgent"] {
    ...
    connect(input) {
        if (this.transport === "single") {
            ...
            return withAbortErrorHandling((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$client$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["transformHttpEventStream"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$client$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["runHttpRequest"])(this.singleEndpointUrl, requestInit)));
        }
        return withAbortErrorHandling((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$client$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["transformHttpEventStream"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$client$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["runHttpRequest"])(`${this.runtimeUrl}/agent/${this.agentId}/connect`, this.requestInit(input))));
    }
    run(input) {
        if (this.transport === "single") {
            if (!this.singleEndpointUrl) throw new Error("Single endpoint transport requires a runtimeUrl");
...
*/ var AgentRegistry = class {
	...
	*/ applyHeadersToAgent(agent) {
        if (agent instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$client$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["HttpAgent"]) agent.headers = {
            ...this.core.headers
        };
    }
    /**
...
*/ var ContextStore = class {
	...
	*/ addContext({ description, value }) {
        const id = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["randomUUID"])();
        this._context[id] = {
            description,
            value
        };
...
*/ var SuggestionEngine = class {
	...
	*/ initialize(suggestionsConfig) {
        for (const config of suggestionsConfig)this._suggestionsConfig[(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["randomUUID"])()] = config;
    }
    /**
	...
	*/ reloadSuggestions(agentId) {
        ...
        for (const config of Object.values(this._suggestionsConfig)){
            ...
            const suggestionId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["randomUUID"])();
	...
	*/ extractSuggestions(messages, suggestionId, consumerAgentId, isRunning) {
        ...
        for (const message of newMessages)if (message.role === "assistant" && message.toolCalls) {
            for (const toolCall of message.toolCalls)if (toolCall.function.name === "copilotkitSuggest") {
                const parsed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$utils$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["partialJSONParse"])(Array.isArray(toolCall.function.arguments) ? toolCall.function.arguments.join("") : toolCall.function.arguments);
...
*/ var RunHandler = class {
	...
	*/ addTool(tool) {
        if (this._tools.findIndex((t)=>t.name === tool.name && t.agentId === tool.agentId) !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$logger$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["logger"].warn(`Tool already exists: '${tool.name}' for agent '${tool.agentId || "global"}', skipping.`);
            return;
        }
...
var IntelligenceAgent = class IntelligenceAgent extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$client$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["AbstractAgent"] {
    config;
    socket = null;
    activeChannel = null;
    threadId = null;
	...
	*/ run(input) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Observable"]((observer)=>{
            ...
            const socket = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$phoenix$2f$priv$2f$static$2f$phoenix$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Socket"](this.config.url, {
            ...
            channel.on(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$constants$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AG_UI_CHANNEL_EVENT"], (payload)=>{
                observer.next(payload);
                if (payload.type === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EventType"].RUN_FINISHED) {
                    observer.complete();
                    this.cleanup();
                } else if (payload.type === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EventType"].RUN_ERROR) {
	...
	*/ connect(input) {
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$rxjs$2f$dist$2f$cjs$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Observable"]((observer)=>{
            ...
            channel.on(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$copilotkitnext$2f$shared$2f$dist$2f$constants$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["AG_UI_CHANNEL_EVENT"], (payload)=>{
                observer.next(payload);
                if (payload.type === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EventType"].RUN_FINISHED || payload.type === __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EventType"].RUN_ERROR) {
                    observer.complete();
                    this.cleanup();
                }
            });
            channel.join().receive("ok", ()=>{
                channel.push(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EventType"].CUSTOM, {
                    type: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$ag$2d$ui$2f$core$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["EventType"].CUSTOM,
                    name: "connect",
                    value: {
                        threadId: input.threadId
                    }
...
//# sourceMappingURL=node_modules_%40copilotkitnext_b5eb6ca9._.js.map